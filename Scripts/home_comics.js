...
for(let i=0;i<8; i++){
  ...
  `<div class="image_activator">
    ...
    <div class="what_todo_2">
      <button id = "bbuuttnn" class="boxes" onclick="close_off()">
        X
      </button>

      <div class="sneak_title">
        ${datta_store.data.results[0].title}
      </div>

      <div class="what_todo_3">
       ${datta_store.data.results[0].description}
      </div>

      <div class="what_todo_4">
        Creators:
        <div class="what_todo_5" id="creator_${i}">
        </div>
      </div>

      <div class="what_todo_6">
        Characters:
        <div class="what_todo_7" id="characcetrs_${i}">
        </div>
      </div>

      <div class="buttum_sec">

        <div class="buttum_sec_date">
          Published:<br><div class="oh_no_my_date">${only_on_sale_date}</div>
        </div>

        <div>
          <a class="source_link" href="${datta_store.data.results[0].urls[0].url}"target="_blank">Source</a>
        </div>
  ...
  // creators displayers starts
            ...
            for(let t =0; t<w;t++){
              if(t+1<w){
                ...
                creator_var.innerHTML += 
                `<div>${datta_store.data.results[0].creators.items[t].name}:&nbsp;</div>
                <div>${datta_store.data.results[0].creators.items[t].role}.`
  ...
  // characters displayers starts
                                                                                                           ...
                                                                                                           for(let k=0; k<g;k++){
                                                                                                            ...
                                                                                                            //  var jay = k;
                                                                                                             ...
                                                                                                             `<div class="what_todo_8">
                                                                                                                <div>${datta_store.data.results[0].characters.items[k].name}</div>
                                                                                                                <div class="what_todo_9_${k}" ></div>
                                                                                                              </div>`;
                                                                                                              console.log("count 2");
                                                                                                                            ...
                                                                                                                            //  var comics_char_data_extract = async ()=>{
                                                                                                                              console.log("count 3");
                                                                                                                                ...
                                                                                                                                //  
                                                                                                                                 ...
                                                                                                                                 var guulu = document.getElementById(`characcetrs_${i}`).getElementsByClassName(`what_todo_9_${k}`)[0];
                                                                                                                                // var guulu = document.getElementById(`what_todo_8_${jay}`);
                                                                                                                                guulu.innerHTML += `<img id="char_image" src=${thumbnail_2}/standard_large.${extension_2}>`
                                                                                                                                console.log("what to tdo 8:"+guulu);
                                                                                                                                //  characcetrs_var.innerHTML += ``;
